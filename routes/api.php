...
Route::get('/edit/{id}/product', [ProductController::class,'edit_product'])->name('product.edit');
Route::post('/update/{id}/product', [ProductController::class,'update_product'])->name('product.update');
